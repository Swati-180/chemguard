      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 pl-2 cursor-pointer group">
          <Avatar className="h-8 w-8 border border-white/10 p-0.5">
            <AvatarImage src={`https://picsum.photos/seed/${user?.uid || 'pharma'}/40/40`} />
            <AvatarFallback className="bg-secondary text-primary">PH</AvatarFallback>
          </Avatar>
          <div className="text-left hidden sm:block">
            <div className="flex items-center gap-1.5">
              <p className="text-xs font-bold text-white/90">{user?.displayName || "Pharma Lab User"}</p>
        ...
        <AlertDialog>
          ...
          <AlertDialogContent className="glass-card bg-background/95 border-white/10">
            <AlertDialogHeader>
              <AlertDialogTitle className="text-white font-headline font-bold uppercase tracking-widest">Neural Link Termination</AlertDialogTitle>
              <AlertDialogDescription className="text-muted-foreground">
                Confirm session termination. All unsaved laboratory progress will be lost.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
